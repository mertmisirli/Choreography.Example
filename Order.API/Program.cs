...
builder.Services.AddDbContext<OrderAPIDbContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("PostgreSql")));
...
app.MapPost("/create-order", async (CreateOrderVM model, OrderAPIDbContext context, IPublishEndpoint publishEndpoint) =>  
{
    ...
    Order.API.Models.Order order = new()
    {
        ...
        OrderStatu = Order.API.Enums.OrderStatu.Suspended,
